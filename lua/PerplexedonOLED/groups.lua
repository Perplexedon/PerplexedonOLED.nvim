...
local function setup(configs)
   ...
   return {
      ...
      DiagnosticInfo = { fg = colors.help, },
      DiagnosticHint = { fg = colors.help, },
      DiagnosticUnderlineError = { undercurl = true, sp = colors.error, },
      DiagnosticUnderlineWarn = { undercurl = true, sp = colors.warning, },
      DiagnosticUnderlineInfo = { undercurl = true, sp = colors.help, },
      DiagnosticUnderlineHint = { undercurl = true, sp = colors.help, },
      DiagnosticSignError = { fg = colors.error, },
      DiagnosticSignWarn = { fg = colors.warning, },
      DiagnosticSignInfo = { fg = colors.help, },
      DiagnosticSignHint = { fg = colors.help, },
      DiagnosticFloatingError = { fg = colors.error, },
      DiagnosticFloatingWarn = { fg = colors.warning, },
      DiagnosticFloatingInfo = { fg = colors.help, },
      DiagnosticFloatingHint = { fg = colors.help, },
      DiagnosticVirtualTextError = { fg = colors.error, },
      DiagnosticVirtualTextWarn = { fg = colors.warning, },
      DiagnosticVirtualTextInfo = { fg = colors.help, },
      DiagnosticVirtualTextHint = { fg = colors.help, },

      LspDiagnosticsDefaultError = { fg = colors.error, },
      LspDiagnosticsDefaultWarning = { fg = colors.warning, },
      LspDiagnosticsDefaultInformation = { fg = colors.help, },
      LspDiagnosticsDefaultHint = { fg = colors.help, },
      ...
      LspDiagnosticsUnderlineInformation = { fg = colors.help, undercurl = true, },
      LspDiagnosticsUnderlineHint = { fg = colors.help, undercurl = true, },
