...
local function setup(configs)
   ...
   return {
      ...
      Underlined = { fg = colors.help, underline = true, },
      ...
      DiagnosticInfo = { fg = colors.help, italic = true, },
      DiagnosticHint = { fg = colors.help, italic = true, },
      DiagnosticUnderlineError = { undercurl = true, sp = colors.error, },
      DiagnosticUnderlineWarn = { undercurl = true, sp = colors.warning, },
      DiagnosticUnderlineInfo = { undercurl = true, sp = colors.help, italic = true, },
      DiagnosticUnderlineHint = { undercurl = true, sp = colors.help, italic = true, },
      DiagnosticSignError = { fg = colors.error, },
      DiagnosticSignWarn = { fg = colors.warning, },
      DiagnosticSignInfo = { fg = colors.help, italic = true, },
      DiagnosticSignHint = { fg = colors.help, italic = true, },
      DiagnosticFloatingError = { fg = colors.error, },
      DiagnosticFloatingWarn = { fg = colors.warning, },
      DiagnosticFloatingInfo = { fg = colors.help, italic = true, },
      DiagnosticFloatingHint = { fg = colors.help, italic = true, },
      DiagnosticVirtualTextError = { fg = colors.error, },
      DiagnosticVirtualTextWarn = { fg = colors.warning, },
      DiagnosticVirtualTextInfo = { fg = colors.help, italic = true, },
      DiagnosticVirtualTextHint = { fg = colors.help, italic = true, },

      LspDiagnosticsDefaultError = { fg = colors.error, },
      LspDiagnosticsDefaultWarning = { fg = colors.warning, },
      LspDiagnosticsDefaultInformation = { fg = colors.help, italic = true, },
      LspDiagnosticsDefaultHint = { fg = colors.help, italic = true, },
      ...
      LspDiagnosticsUnderlineInformation = { fg = colors.help, undercurl = true, italic = true, },
      LspDiagnosticsUnderlineHint = { fg = colors.help, undercurl = true, italic = true, },
